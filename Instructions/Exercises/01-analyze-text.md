...
1. 在 Visual Studio Code 的“资源管理器”窗格中，浏览到 **Labfiles/01-analyze-text** 文件夹，然后根据语言首选项展开 **CSharp** 或 **Python** 文件夹及其包含的 “**text-analysis**” 文件夹。
...
4. 更新配置值以包括创建的 Azure 语言资源的**终结点**和**密钥**（在 Azure 门户 中 Azure AI 语言资源的“**密钥和终结点**”页上可用）
5. 保存此配置文件。
