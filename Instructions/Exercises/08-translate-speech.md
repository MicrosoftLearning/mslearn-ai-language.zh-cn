...
1. 在 Visual Studio Code 的“资源管理器”窗格中，浏览到 08-speech-translation 文件夹，并根据你的语言首选项展开 C-Sharp 文件夹或 Python 文件夹。 每个文件夹都包含要在其中集成 Azure AI 语音功能的应用的语言特定代码文件。
...
1. 在**资源管理器窗格中的 **“翻译器**”文件夹中，打开**首选语言的配置文件
...
1. 请注意，Main 函数中已经提供了从配置文件加载认知服务密钥和区域的代码。 必须使用这些变量为认知服务资源创建将用于翻译语音输入的 SpeechTranslationConfig。 在注释“配置翻译”下添加以下代码：
...
有关如何使用语音翻译 API 的详细信息，请参阅语音翻译文档。
